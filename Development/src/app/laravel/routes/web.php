...
/*新規会員登録画面の遷移先*/
Route::post('/users-menu/users/create', [UserController::class, 'post'])->name('users.post');

/*新規会員登録作成画面の表示*/
Route::get('/users-menu/users/create', [UserController::class, 'create'])->name('users.create');

/*確認画面の表示*/
Route::get('/users-menu/users/create/confirm', [UserController::class, 'confirm'])->name("users.confirm");

/*確認画面からフォーム遷移先*/
Route::post('/users-menu/users/create/confirm', [UserController::class, 'send'])->name('users.send');

/*完了（登録）アクション*/
Route::get('/users-menu/users/create/confirm/thanks', [UserController::class, 'complete'])->name("users.complete");
...
/*会員検索画面への遷移*/
Route::get('/users-menu/users/search', [UserController::class, 'search'])->name('users.search');

/*会員情報一覧画面への遷移*/
Route::get('/users-menu/users/search/index', [UserController::class, 'index'])->name("users.index");

/*会員詳細画面への遷移*/
Route::get('/users-menu/users/search/index/{id}', [UserController::class, 'show'])->name('users.show');
...
*/
/*退会*/
Route::delete('/users-menu/users/search/index/{id}', [UserController::class, 'destroy'])->name('users.destroy');;
